...
const double kB = 1.38065e-23;  // Boltzmann's constant
...
int main()
{
	...
	U = ens->calculate() * dataContainer.epsK;  // in eV
	K = atoms.getEnergy() * dataContainer.epsK;  // in eV
...
void GetParameters(dataT *d) {
	...
	if (inputFile.is_open()) {
		...
		// Temperary input of relaxation time
		d->tau_s = 0.0;
